...
import { AuthRegister } from '../config/service/AuthService'
...
export default function Register() {
  ...
  const register = async (e) => {
    ...
    if (name.trim().length === 0 && email.trim().length === 0 && email.endsWith("@gmail.com") && username.trim().length === 0 && password.trim().length === 0) {
    ...
    AuthRegister(APP_API.auth, formData, location)
  }
  return (
    <>
      <div className="flex h-[100vh] overflow-auto text-white flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-black">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm mt-30">
          ...
          <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">
            <span className="text-3xl text-indigo-600">Y</span> platformasidan ro'yxatdan o'ting!
          </h2>
        </div>
